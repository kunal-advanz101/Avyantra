...
export class HospitalStaffComponent implements OnInit {
  ...
  getBranches() {
    this.commomService.getHospitalBranches(this.hospitalId).subscribe(response => {
  ...
  getBranchStaff() {
    this.commomService.getStaff(this.hospitalId, this.hospitalBranchId, this.page, this.pageLength).subscribe(response => {
      if (this.helper.success(response)) {
  ...
  nextPage(page) {
   ...
   getBranchStaffCount() {
    this.commomService.getStaffCounts(this.hospitalId, this.hospitalBranchId).subscribe(response => {
      if (this.helper.success(response)) {
