...
export class SettingsComponent implements OnInit {
  ...
  updatedRole: string; updatedSpeciality: string; roleJson: any = {}; branchList = [];
  ...
  getUser() {
    this.commonService.getStaff(this.hospitalId, this.hospitalBranchId, this.page, this.pageLength).subscribe(response => {
      if (this.helper.success(response)) {
  ...
  getUsersCount() {
    this.commonService.getStaffCounts(this.hospitalId, this.hospitalBranchId).subscribe(response => {
      if (this.helper.success(response)) {
  ...
  getBranches(hospitalId) {
    this.commonService.getHospitalBranches(this.hospitalId).subscribe(response => {
      if (this.helper.success(response)) {
