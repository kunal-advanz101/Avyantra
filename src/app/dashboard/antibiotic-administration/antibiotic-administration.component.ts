  ...
  updateAntibioticForm(){
   this.setData();
    if(!this.antibioticAdministrationForm.valid){
      ...
      this.common_api.updateFormData('patient/update/baby_antibiotic/',this.id,this.readingDataService.reading,this.antibioticAdministrationForm['value']).subscribe(result=>{
