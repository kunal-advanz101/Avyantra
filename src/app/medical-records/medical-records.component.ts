...
export class MedicalRecordsComponent implements OnInit {
  ...
  updateMedicalRecord() {
    ...
    this.commomService.updateMedicalRecord(this.study_id,this.patient_id,this.hospitalId,this.hospitalBranchId, this.addMedicalRecordForm['value']).subscribe(result=>{
    if(this.helper.success(result)){
